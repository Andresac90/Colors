    ...
    void Start()
    {
        ...
        if (identifier.StartsWith("iPhone"))
        {
            if(scene.name == "Juego")
            {
                ...
                {
                    scoremenu.transform.position = scoremenu.transform.position + new Vector3(0, -110, 0);
                    pausemenu.transform.position = pausemenu.transform.position + new Vector3(0, -110, 0);
                }
