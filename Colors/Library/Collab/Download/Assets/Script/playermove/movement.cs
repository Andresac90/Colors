...
public class movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        speedrester = Random.Range(1.0f, 5.0f);
        ...
        {
            Distancia.distanceBetween = 14;
            Distancia.distancebetweenMin = 14;
            Distancia.distancebetweenMax = 16;
            speedMultiplier = 1.04f;
            myRigidBody.gravityScale = 4.4f;
            jumpForce = 16.1f;
        }

        if (speed >= 31 && speed < 36)
        {
            Distancia.distanceBetween = 14.5f;
            Distancia.distancebetweenMin = 14.5f;
            Distancia.distancebetweenMax = 16.5f;
            speedMultiplier = 1.04f;
        ...
        if (speed >= 37)
        {
            Distancia.distanceBetween = 15;
            Distancia.distancebetweenMin = 15;
            Distancia.distancebetweenMax = 17;
            myRigidBody.gravityScale = 4.6f;
            jumpForce = 16;
